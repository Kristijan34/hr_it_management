 ...
 ********************************************************************************/
class hr_Employee_absencesViewDetail extends ViewDetail {
...
//send for approval
        ...
        if ($this->bean->status == "new" ) {
            if($this->bean->created_by == $current_user->id){
                $this->dv->defs['templateMeta']['form']['buttons'][] = array(
...
//
//
//        if($this->bean->correction_status == 'send_for_approval'){
//            $this->bean->isCorrectionApproved($this->bean->id);
//        }
        parent::display();
    }
}
