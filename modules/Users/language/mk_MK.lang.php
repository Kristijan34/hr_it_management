...
$mod_strings = array(
    ...
    'LBL_DELETE_USER_CONFIRM' => 'Кога се брише Корисник, се бришат и податоците за соодветниот Вработен. Откако ќе се избрише Корисник, сите конекции и извештаи кои го вклучуваат избришаниот Корисник, може да треба да се освежат.<br/><br/> Бришењето на Корисник не може да се врати.',
    ...
    'ERR_IE_MISSING_REQUIRED' => "Во влезните Е-Мејл подесувања недостасува задолжителна информација.\n Ве молиме проверете ги опциите и пробајте повторно.\n\nАко не подесувате влезен Е-мејл, ве молиме избришете ги сите полиња од оваа секција.",
