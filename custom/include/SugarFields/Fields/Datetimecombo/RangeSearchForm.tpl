...
<input autocomplete="off" type="text" name="range_{$id}" id="range_{$id}" value='{if empty($smarty.request.{{$id_range}}) && !empty($smarty.request.{{$original_id}})}{$smarty.request.{{$original_id}}}{else}{$smarty.request.{{$id_range}}}{/if}' title='{{$vardef.help}}' {{$displayParams.field}} {{if !empty($tabindex)}} tabindex='{{$tabindex}}' {{/if}} size="11" class="dateRangeInput {if $custom_readonly eq 1} custom_input_readonly{/if}"{if $custom_readonly eq 1} readonly{/if}>
...
<input autocomplete="off" type="text" name="start_range_{$id}" id="start_range_{$id}" value='{$smarty.request.{{$id_range_start}} }' title='{{$vardef.help}}' {{$displayParams.field}} tabindex='{{$tabindex}}' size="11" class="dateRangeInput{if $custom_readonly eq 1} custom_input_readonly{/if}"{if $custom_readonly eq 1} readonly{/if}>
{{if !$displayParams.hiddeCalendar}}
...
{$APP.LBL_AND}
{assign var=date_value value={{sugarvar key='value' string=true}} }
<input autocomplete="off" type="text" name="end_range_{$id}" id="end_range_{$id}" value='{$smarty.request.{{$id_range_end}} }' title='{{$vardef.help}}' {{$displayParams.field}} tabindex='{{$tabindex}}' size="11" class="dateRangeInput{if $custom_readonly eq 1} custom_input_readonly{/if}" maxlength="10"{if $custom_readonly eq 1} readonly{/if}>
{{if !$displayParams.hiddeCalendar}}
